...
Module Info.
  ...
  Definition source_file := "strlen_1.c"%string.
...
Definition f_strlen := {|
  ...
  fn_vars := nil;
  fn_temps := ((_i, tuint) :: (_t'1, (tptr tuchar)) :: (_t'2, tuchar) :: nil);
  fn_body :=
(Ssequence
  ...
  (Ssequence
    (Sloop
      (Ssequence
        (Ssequence
          (Ssequence
            (Sset _t'1 (Etempvar _s (tptr tuchar)))
            (Sset _s
...
(_strlen :: ___builtin_debug :: ___builtin_nop ::
