...
Module Info.
  ...
  Definition source_file := "/home/nika/Desktop/Work/strncat.c"%string.
...
Definition _dest_len : ident := 60%positive.
...
Definition _strncat : ident := 61%positive.
...
Definition f_strncat := {|
  ...
  fn_params := ((_dest, (tptr tuchar)) :: (_src, (tptr tuchar)) ::
                (_n, tuint) :: nil);
  fn_vars := nil;
  fn_temps := ((_dest_len, tuint) :: (_i, tuint) :: (_t'2, tint) ::
               (_t'1, tuint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Sset _dest_len (Etempvar _t'1 tuint)))
  (Ssequence
    (Ssequence
      (Sset _i (Econst_int (Int.repr 0) tint))
      (Sloop
...
(_strncat :: _strlen :: ___builtin_debug :: ___builtin_nop ::
